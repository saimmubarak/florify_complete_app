...
def handler(event, context):
    ...
    try:
        ...
        blueprint_item = {
            ...
            "pipelinePngWithSkinsUrl": s3_pipeline_png_with_skins,  # S3 URL for 512×512 pipeline PNG with skins
        ...
        response_item = {
            ...
            "pipelinePngWithSkinsUrl": s3_pipeline_png_with_skins,
            "createdAt": current_time,
            "updatedAt": current_time
        }
